...
function generateCVContent(profile: any, template: TemplateType, sections: SectionVisibility, colorOverrides?: ColorOverrides, qrHtml?: string): string {
